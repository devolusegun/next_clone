  ...
  return (
    <header className="container flex items-center justify-between py-6">
      <div className="flex items-center gap-3">
        ...
        <div className="font-bold text-lg">FION</div>
      </div>
      <nav className="hidden md:flex items-center gap-6">
        <Link href='/features' className="text-slate-600 hover:text-slate-800">Ideas Bank</Link>
        <Link href='/pricing' className="text-slate-600 hover:text-slate-800">About FION</Link>
